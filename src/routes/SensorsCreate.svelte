...
<div class="card" style="height: 100%;">
	<div class="card-header">
		<div class="row">
			...
			<div class="col-md-10">
				<h3 class="text-center">Criar Sensor</h3>
			</div>
	...
	<div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <!-- <input type="text" class="form-control" bind:value="{name}" required> -->
						<select class="form-select" bind:value="{sensor_type}" required>
							...
							<option value="water conductivit">Condutividade da água</option>
						</select>
          </div>
					<div class="col-md-6">
            <label for="name" class="form-label">Viveiro:</label>
						<select class="form-select" bind:value="{nursery_id}" required>
        ...
        <div class="row mt-3">
          <div class="col-auto">
            <button type="button" on:click="{doPost}" class="btn btn-outline-success">Salvar</button>
          </div>
        </div>
      </div>
      <div class="col-md-1"></div>
